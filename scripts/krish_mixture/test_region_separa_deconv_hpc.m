...
% fitting parameters
shifttimeadd=0;%time point to shift. mostly 76 for experimental dataset 0 for simulated dataset and CRAFT data
...
range_tab=[nan nan; 0.01 lambdamax_arg; 0.1/10^7 20; 0 0];%f, lambda, A, phi
